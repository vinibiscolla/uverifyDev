...
(function (f) {
    ...
    v.ext.buttons.copyHtml5 = {
        className: `buttons-copy buttons-html5 bg_grey`,
        text: function (a) {
            return a.i18n("buttons.copy", `Copiar &nbsp; <i class="fa fa-copy"> </i>`)
        },
    ...
    v.ext.buttons.csvHtml5 = {
        bom: !1,
        className: "buttons-csv buttons-html5 bg_grey",
        available: function () {
            return g.FileReader !== w && g.Blob
        },
        text: function (a) {
            return a.i18n("buttons.csv", `CSV &nbsp; <i class="fa fa-file-excel"> </i>`)
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            a = I(b, c).str;
    ...
    v.ext.buttons.excelHtml5 = {
        className: "buttons-excel buttons-html5 bg_grey",
        available: function () {
            return g.FileReader !== w && (z || g.JSZip) !== w && !J() && C
        },
        text: function (a) {
            return a.i18n("buttons.excel", `Excel &nbsp; <i class="fa fa-file-excel"> </i>`)
        },
        action: function (a, b, d, c) {
            this.processing(!0);
            var p = this,
    ...
    v.ext.buttons.pdfHtml5 = {
        className: "buttons-pdf buttons-html5 bg_grey",
        available: function () {
            return g.FileReader !== w && (t || g.pdfMake)
        },
        text: function (a) {
            return a.i18n("buttons.pdf", `PDF &nbsp; <i class="fa fa-file-pdf"> </i>`)
        },
        action: function (a, b, d, c) {
            this.processing(!0);
